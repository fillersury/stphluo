    ...
    return (
        ...
        >
            <div className="max-w-5xl mx-auto flex flex-col items-center px-5 md:px-0 py-10 md:py-16">
                {image && (
                    <img src={image} alt={title} className="max-w-3xs sm:max-w-sm px-10 py-5 sm:px-0 sm:py-16" />
                )}
                <div className={`grid grid-cols-1 md:grid-cols-4 gap-10 py-6 px-10 md:px-16 w-full ${cardColor} rounded-3xl`}>
                    <div>
                        <h1 className={`${textColor} text-lg md:text-xl font-bold mb-2 md:mb-4`}>Timeline</h1>
                    ...
                    <div>
                        <h1 className={`${textColor} text-lg md:text-xl font-bold mb-2 md:mb-4`}>Role</h1>
                        <p className="text-sm md:text-base">📝 {role_text}</p>
                    </div>
                    <div>
                        <h1 className={`${textColor} text-lg md:text-xl font-bold mb-2 md:mb-4`}>Projects</h1>
                    ...
                    <div>
                        <h1 className={`${textColor} text-lg md:text-xl font-bold mb-2 md:mb-4`}>Tools</h1>
